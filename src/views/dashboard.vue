...
export default {
  data() {
    return {
      ...
      item: true,
      items: [
        { title: 'الرئيسية', icon: 'mdi-chart-areaspline' , link: '/dashboard'},
        { title: 'الطلاب', icon: 'mdi-account', link: '/dashboard/users' },
        { title: 'اضافة امتحان', icon: 'mdi-format-align-justify', link: "/dashboard/redirector/*dashboard*addExam" },
        { title: 'تعليمات الامتحان القادم', icon: 'mdi-format-align-justify', link: '/dashboard/nextExamInstructions' },
        { title: 'الامتحانات', icon: 'mdi-format-align-justify', link: '/dashboard/exams' },
        { title: 'امتحانات الزائرين', icon: 'mdi-format-align-justify', link: '/dashboard/exams-visitors' },
        { title: 'اجابات الامتحانات', icon: 'mdi-format-align-justify', link: '/dashboard/answers' },
        { title: 'ترتيب الطلبة', icon: 'mdi-format-align-justify', link: '/dashboard/students_grades' },
        { title: 'معلومات المدرس', icon: 'mdi-format-align-justify', link: '/dashboard/adminData' },
        { title: 'البث المباشر', icon: 'mdi-format-align-justify', link: '/liveVideo' },
        { title: 'رفع درس جديد', icon: 'mdi-format-align-justify', link: '/dashboard/uploadVideo' },
        { title: 'الدروس', icon: 'mdi-format-align-justify', link: '/dashboard/videos' },
      ],
      mini: true,
      bar: 'Dashboard'
    }
