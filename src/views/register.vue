  ...
  <div class="container register-wrapper m-auto shadow p-0">
    <div class="row">
      <div class="col-md-6 d-flex justify-content-center align-items-center">
          <img src="../../src/assets/images/study.jpg" alt="" width="600" height="auto"/>
      </div>
      <div class="col-md-6" style="background: #fbfbfb;">
          ...
          <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  <h3 class="register-heading">{{ type==='update'?'تعديل بيانات الطالب':mode==='signin'?'تسجيل الدخول':'انشاء حساب'}}</h3>
                  <p>بالرجاء ادخال بياناتك صحيحة والتأكد منها وسيتم فى اول مرة يتم التسجيل فيها انتظار موافقة الاستاذ المشرف</p>
                  <div class="row register-form">
                      <div class="col-md-6">
                          <div v-if="mode==='signup' || type==='update'" class="form-group">
                      ...
                      <div class="col-12">
                        <button
                          ...
                          @click.prevent="() => {type==='update'?update():mode==='signin'?signin():signup()}">
                          {{ mode==='signin'?'تسجيل الدخول' : 'انشاء حساب'}}
                        </button>

                        <button
                          class="btn btn-link btn-block"
                          v-if="type==='exams' || type==='examsOnly' || type==='fullCourse'"
                          @click="switchMode">
   ...
   data() {
        ...
        methods: {
            ...
            signup() {
              ...
              this.$v.password.$touch();
              if(this.$v.$anyError) return;
                 this.$store.dispatch('signup', {email: this.email, password: this.password, fullname: this.fullname, stage: this.stage, phone: this.phone, address: this.address, type: this.type})
            },
            update() {
              this.$v.email.$touch();
              this.$v.password.$touch();
