...
<div class="container" style="margin-top:200px;">
    ...
    <button ref="modal_button" style="display:none" type="button" class="btn btn-primary" data-toggle="modal" data-target=".lesson">Large modal</button>

    <div id="lesson" @click.prevent="" class="modal fade lesson" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div style="margin-top:110px;margin-left:auto;margin-right:auto;background-color:#333;width:90%;height:100%;" class="modal-dialog modal-lg">
          <div style="height: 800px;overflow-y:scroll" class="modal-content">
            <video style="width:100%;height:100%;" v-if="ready && method==='upload'" :src="video.videoPath" controls></video>
            <iframe v-if="ready && method==='embedded'" width="100%" height="100%" :src="video.videoPath"/>
            <div class="explain">
...
export default {
    ...
    methods: {
        play(vid) {
            ...
            this.video = vid;
            this.method = this.video.videoPath.split('youtube').length>1?'embedded': 'upload';
            this.ready = true;
        },
    },
    watch: {
