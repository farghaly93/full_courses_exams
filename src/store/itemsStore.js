import axios from 'axios';
  ...
  const mutations = {
    ...
    getStageStudentsOrder(state, data) {
      state.fullDegree = data.fullDegree;
    },
    orderModalOpen(state) {
      state.order_modal = !state.order_modal;
    }
  };
  ...
  const actions = {
    ...
    getExamsFullDegree({rootState, commit}, data) {  
      axios.get('/getStageStudentsOrder/'+data.stage+'/'+data.type).then(res => {
        console.log(res.data.fullDegree);
        commit('getStageStudentsOrder', {fullDegree: res.data.fullDegree});
      })
    },
    orderModalOpen({commit}) {  
      commit('orderModalOpen');
    }  
  };
  ...
  const getters = {
    ...
    fullDegree() {
      return state.fullDegree;
    } ,
    order_modal() {
      return state.order_modal;
    } 
  }
